...
embeded_component = {'Link_badge' : """<script src="https://platform.linkedin.com/badges/js/profile.js" async defer type="text/javascript"></script>
<div class="badge-base LI-profile-badge" data-locale="en_US" data-size="medium" data-theme="light" data-type="VERTICAL" data-vanity="edmund-quarm" data-version="v1"><a class="badge-base__link LI-simple-link" href="https://de.linkedin.com/in/edmund-quarm?trk=profile-badge">Edmund Quarm</a></div>
...
with st.sidebar:
  components.html(embeded_component['Link_badge'] ,height = 310)

st.sidebar.caption('Wish to connect?')

st.sidebar.write('📧: ekow.quarm@rwth-aachen.de')

pdfFileObj = open('CVQuarm.pdf', 'rb')

st.sidebar.download_button('Download resume', pdfFileObj, file_name='Awesome_CV__Edmund(3).pdf', mime = 'pdf')
...
st.info('''
-I am a Computational Social Systems Data Science student at RWTH with a focus on the ethics of Human-Technology Interactions. I am passionate
about teaching machines how to think independently.
''')
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #16A2CB;">
  <a class="navbar-brand" href="https://www.linkedin.com/in/edmund-quarm/" target="_blank">Edmund E. Quarm</a>
...
txt('**Msc.** (Computational Social Systems), *RWTH Aachen University*, Aachen, Germany',
'2020- Present')
st.markdown('''
- CGPA: `2.5`
- Major in Ethics of Human Technology Interaction
-  Relevant Course Work: Supervised/Unsupervised Learning, Python I, Database and Information Systems, Business Process Intelligence, Applied Ethics, Data Structures and Algorithms, Computer Mediated Communication, Ethics Technology and Data, Introduction to Algorithmic Societies, Empirical Research Methods in Psychology.
''')

txt('**Bachelors of Arts** (Sociology and Chinese), *University of Ghana*, Ghana',
'2013-2019')
st.markdown('''
- GPA: `3.24`
...
txt('**Intern Office Assistant/ Translator**, Zoomlion Ghana Limited, Ghana',
'2018-2019')
st.markdown('''
- Assisted international relations officers in the day to day administration of the office. 
- Planned and prepared international trips for about 35 company staff.
- Helped in acquiring Ghanaian resident and work permits for Turkish and American expatriate staff.
- Liaised and communicated with international branches in Angola and Zambia to help in acquisition of safety gears for company staff for day to
day operations.
''')
...
txt3('Data processing/wrangling', '`MySQL`, `pandas`, `numpy`')
txt3('Data visualization', '`matplotlib`, `seaborn`, `plotly`, `ggplot2`')
txt3('Machine Learning', '`scikit-learn`')
txt3('Deep Learning', '`TensorFlow`')
txt3('Process Mining', '`ProM Process Mining tool`, `Fluxicon by Disco`')
#txt3('Web development', '`Flask`, `HTML`, `CSS`')
txt3('Model deployment', '`streamlit`, `RapidMiner`')

#####################
st.markdown('''
## Social Media
''')
txt2('LinkedIn', 'https://www.linkedin.com/in/edmund-quarm/')
